...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out mindvex artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <mindvex', 'Foo bar '],
      ['Foo bar <mindvext', 'Foo bar <mindvext'],
      ['Foo bar <mindvexA', 'Foo bar '],
      ['Foo bar <mindvexArtifacs></mindvexArtifact>', 'Foo bar <mindvexArtifacs></mindvexArtifact>'],
      ['Before <mindvexArtfiact>foo</mindvexArtifact> After', 'Before <mindvexArtfiact>foo</mindvexArtifact> After'],
      ['Before <mindvexArtifactt>foo</mindvexArtifact> After', 'Before <mindvexArtifactt>foo</mindvexArtifact> After'],
    ])('should correctly parse chunks and strip out mindvex artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <mindvexArtifact title="Some title" id="artifact_1">foo bar</mindvexArtifact> Some more text',
        {
      ...
      [
        [
          ...
          'o',
          '<',
          '/mindvexArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <mindvexArtifact title="Some title" id="artifact_1">foo</mindvexArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <mindvexArtifact title="Some title" id="artifact_1"><mindvexAction type="shell">npm install</mindvexAction></mindvexArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <mindvexArtifact title="Some title" id="artifact_1"><mindvexAction type="shell">npm install</mindvexAction><mindvexAction type="file" filePath="index.js">some content</mindvexAction></mindvexArtifact> After',
        {
          output: 'Before  After',
