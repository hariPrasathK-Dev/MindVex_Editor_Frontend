  ...
  ({
    ...
    return (
      <div className="relative z-port-dropdown" ref={dropdownRef}>
        ...
        {isDropdownOpen && (
          <div className="absolute left-0 mt-2 bg-mindvex-elements-background-depth-2 border border-mindvex-elements-borderColor rounded shadow-sm min-w-[140px] dropdown-animation">
            <div className="px-4 py-2 border-b border-mindvex-elements-borderColor text-sm font-semibold text-mindvex-elements-textPrimary">
              Ports
            </div>
            {sortedPreviews.map((preview) => (
              <div
                key={preview.port}
                className="flex items-center px-4 py-2 cursor-pointer hover:bg-mindvex-elements-item-backgroundActive"
                onClick={() => {
                ...
                <span
                  className={
                    activePreviewIndex === preview.index
                      ...
                      : 'text-mindvex-elements-item-contentDefault group-hover:text-mindvex-elements-item-contentActive'
                  }
                >
                  {preview.port}
                </span>
