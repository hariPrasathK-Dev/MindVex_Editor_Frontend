...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
    ...
    return (
      <div
        ...
        style={{
          ...
          height: '100%',
          cursor: 'ew-resize',
          background: 'var(--mindvex-elements-background-depth-4, rgba(0,0,0,.3))',
          display: 'flex',
          alignItems: 'center',
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.background = 'var(--mindvex-elements-background-depth-4, rgba(0,0,0,.3))')
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.background = 'var(--mindvex-elements-background-depth-3, rgba(0,0,0,.15))')
        }
  ...
  const GripIcon = () => (
    ...
    >
      <div
        style={{
          color: 'var(--mindvex-elements-textSecondary, rgba(0,0,0,0.5))',
          fontSize: '10px',
          lineHeight: '5px',
          userSelect: 'none',
          marginLeft: '1px',
  ...
  return (
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-mindvex-elements-background-depth-2 p-2 flex items-center gap-2">
        <div className="flex items-center gap-2">
          <IconButton icon="i-ph:arrow-clockwise" onClick={reloadPreview} />
          <IconButton
            icon="i-ph:selection"
            onClick={() => setIsSelectionMode(!isSelectionMode)}
            className={isSelectionMode ? 'bg-mindvex-elements-background-depth-3' : ''}
          />
        </div>

        <div className="flex-grow flex items-center gap-1 bg-mindvex-elements-preview-addressBar-background border border-mindvex-elements-borderColor text-mindvex-elements-preview-addressBar-text rounded-full px-1 py-1 text-sm hover:bg-mindvex-elements-preview-addressBar-backgroundHover hover:focus-within:bg-mindvex-elements-preview-addressBar-backgroundActive focus-within:bg-mindvex-elements-preview-addressBar-backgroundActive focus-within-border-mindvex-elements-borderColorActive focus-within:text-mindvex-elements-preview-addressBar-textActive">
          <PortDropdown
        ...
        <div className="flex items-center gap-2">
          ...
          <IconButton
            ...
            className={
              isInspectorMode ? 'bg-mindvex-elements-background-depth-3 !text-mindvex-elements-item-contentAccent' : ''
            }
          ...
          <div className="flex items-center relative">
            ...
            {isWindowSizeDropdownOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-mindvex-elements-background-depth-1 rounded-xl shadow-2xl border border-mindvex-elements-borderColor overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        className={`flex w-full justify-between items-center text-start bg-transparent text-xs text-mindvex-elements-textTertiary hover:text-mindvex-elements-textPrimary`}
                        onClick={() => {
                          openInNewTab();
                        }}
                      >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-mindvex-elements-textTertiary">Show Device Frame</span>
                        <button
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-mindvex-elements-textTertiary">Landscape Mode</span>
                        <button
                  ...
                  {WINDOW_SIZES.map((size) => (
                    <button
                      key={size.name}
                      className="w-full px-4 py-3.5 text-left text-mindvex-elements-textPrimary text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-mindvex-elements-background-depth-3 bg-mindvex-elements-background-depth-1"
                      onClick={() => {
      ...
      <div className="flex-1 border-t border-mindvex-elements-borderColor flex justify-center items-center overflow-auto">
        <div
          style={{
            width: isDeviceModeOn ? (showDeviceFrameInPreview ? '100%' : `${widthPercent}%`) : '100%',
            height: '100%',
            overflow: 'auto',
            background: 'var(--mindvex-elements-background-depth-1)',
            position: 'relative',
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
        ...
        >
          {activePreview ? (
            <>
              {isDeviceModeOn && showDeviceFrameInPreview ? (
                ...
                <iframe
                  ref={iframeRef}
                  title="preview"
                  className="border-none w-full h-full bg-mindvex-elements-background-depth-1"
                  src={iframeUrl}
                  sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin"
            ...
            <div className="flex w-full h-full justify-center items-center bg-mindvex-elements-background-depth-1 text-mindvex-elements-textPrimary">
            ...
            <>
              ...
              <div
                style={{
                  ...
                  background: 'var(--mindvex-elements-background-depth-3, rgba(0,0,0,0.7))',
                  color: 'var(--mindvex-elements-textPrimary, white)',
                  padding: '2px 8px',
                  borderRadius: '4px',
                  fontSize: '12px',
                  pointerEvents: 'none',
