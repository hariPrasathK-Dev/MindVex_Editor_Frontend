      ...
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <motion.div
          ...
          className={classNames(
            'bg-mindvex-elements-background-depth-1 rounded-xl shadow-xl border border-mindvex-elements-borderColor max-w-md w-full max-h-[80vh] flex flex-col',
            className,
          )}
        >
          {/* Header */}
          <div className="p-6 border-b border-mindvex-elements-borderColor flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center">
                <GitBranch className="w-6 h-6 text-blue-600" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-mindvex-elements-textPrimary">Select Branch</h3>
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-lg hover:bg-mindvex-elements-background-depth-1 text-mindvex-elements-textSecondary hover:text-mindvex-elements-textPrimary transition-all"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center p-8 space-y-4">
                ...
                <p className="text-sm text-mindvex-elements-textSecondary">Loading branches...</p>
              </div>
            ) : error ? (
              <div className="flex flex-col items-center justify-center p-8 space-y-4">
                ...
                {branches.length > 10 && (
                  <div className="p-4 border-b border-mindvex-elements-borderColor">
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-mindvex-elements-background-depth-1 border border-mindvex-elements-borderColor text-mindvex-elements-textPrimary placeholder-mindvex-elements-textTertiary focus:outline-none focus:ring-1 focus:ring-mindvex-elements-borderColorActive"
                    />
                  </div>
                )}
                        ...
                        <button
                          ...
                          className={classNames(
                            ...
                            selectedBranch === branch.name
                              ...
                              : 'bg-mindvex-elements-background-depth-1 border-transparent hover:bg-mindvex-elements-background-depth-2',
                          )}
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 min-w-0">
                              <GitBranch className="w-4 h-4 flex-shrink-0 text-mindvex-elements-textSecondary" />
                              <span className="font-medium text-mindvex-elements-textPrimary truncate">
                                {branch.name}
                              </span>
                          ...
                          <div className="text-xs text-mindvex-elements-textSecondary mt-1 truncate">
          ...
          {!isLoading && !error && branches.length > 0 && (
            <div className="p-6 border-t border-mindvex-elements-borderColor flex items-center justify-between">
